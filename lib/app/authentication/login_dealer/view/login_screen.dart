...
class LoginDealerScreen extends StatefulWidget {
  const LoginDealerScreen({super.key});

  @override
  State<LoginDealerScreen> createState() => _LoginDealerScreenState();
}

class _LoginDealerScreenState extends State<LoginDealerScreen> {
  ...
  Widget build(BuildContext context) {
    return BaseScreen(
      viewmodel: LoginDealerViewModel(context: context),
  ...
  Widget _buildTextFields(
      BuildContext context, LoginDealerViewModel viewmodel) {
        ...
        child: ElevatedButton(
          ...
          onPressed: () {
            ...
            AppNav.toNameAndRemoveUntil(
                context, AppNavConstants.MAIN_DEALER_PANG);
          },
          child: Center(
            child: Text(
              text,
